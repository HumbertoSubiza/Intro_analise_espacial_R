...
Las siguientes tablas resumen las principales SGR, con coordenadas geográficas y proyectadas, que podemos encontrar en Uruguay y Brasil.
...
CRS_UTM <- tibble::tribble(
      ~Nombre, ~"código EPSG", ~"Definición formato Proj.4",    ~Observaciones,
  "UTM-23S",   31983, "“+proj=utm +zone=23 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs”",   "Fuso 23 Sur",
  "UTM-24S",   31984, "“+proj=utm +zone=24 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs”",   "Fuso 24 Sur",
  "UTM-25S",   31985, "“+proj=utm +zone=25 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs”",   "Fuso 25 Sur",
  )
